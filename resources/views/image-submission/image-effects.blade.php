...
<body class="bg-gray-100">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Browse all available AI-powered image effects</p>
        </div>
        ...
        <div class="text-center mb-8">
            <button id="load-more-btn" 
                    ...
                    class="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg font-medium transition-colors duration-200 inline-flex items-center">
        ...
        <div class="bg-white rounded-lg shadow-lg p-12 text-center">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mb-2">No Image Effects Available</h2>
            <p class="text-gray-600 mb-6">There are currently no active image effects. Please check back later.</p>
            <a href="{{ route('image-submission.index') }}" 
               class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200">
                <i class="fas fa-arrow-left mr-2"></i>
                Back to All Effects
            </a>
        </div>
