...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50 min-h-screen">
    ...
    <main class="container mx-auto px-4 lg:px-8 py-12">
        ...
        <div class="mb-12 text-center animate-fade-in-up" style="animation-delay: 0.1s;">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-3xl shadow-2xl mb-6">
            ...
            <p class="text-gray-600 text-lg max-w-2xl mx-auto">
                Browse our collection of AI-powered video effects and transform your videos into cinematic masterpieces
            </p>
        </div>
        ...
        <div class="text-center mb-12">
            <button id="load-more-btn" 
                    ...
                    class="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-12 py-4 rounded-full font-bold text-lg transition-all duration-300 shadow-2xl hover:shadow-blue-500/50 inline-flex items-center space-x-3 transform hover:scale-105">
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-16 text-center animate-fade-in-up max-w-2xl mx-auto">
            ...
            <h2 class="text-3xl font-bold text-gray-800 mb-4">No Video Effects Available</h2>
            <p class="text-gray-600 mb-8 text-lg">There are currently no active video effects. Please check back later for exciting new effects!</p>
            <a href="{{ route('image-submission.index') }}" 
               class="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-8 py-4 rounded-full font-bold transition-all duration-300 shadow-xl hover:shadow-blue-500/50">
