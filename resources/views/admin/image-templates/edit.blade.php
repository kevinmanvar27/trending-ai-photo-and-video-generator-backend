        ...
        <form action="{{ route('admin.image-templates.update', $template) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="coins_required" class="block text-sm font-medium text-gray-700 mb-2">
                    Coins Required <span class="text-red-500">*</span>
                </label>
                <div class="relative">
                    ...
                    <input type="number" 
                           name="coins_required" 
                           id="coins_required" 
                           value="{{ old('coins_required', $template->coins_required ?? 5) }}"
                           min="1"
                           max="1000"
                           class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('coins_required') border-red-500 @enderror" 
                           placeholder="5"
                           required>
                </div>
                @error('coins_required')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
                <p class="text-sm text-gray-500 mt-1">Number of coins users will spend to use this template (1-1000)</p>
            </div>
